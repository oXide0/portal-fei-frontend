...
export function ExamDetailPage() {
    const handleEdit = () => {
        // Logic for editing exam details
        console.log('Edit Exam');
    };

    const handleDelete = () => {
        // Logic for deleting the exam
    ...
    return (
        <>
            ...
            <div>
                <h1 className="text-2xl font-bold tracking-tight">Math Final Exam</h1>
            </div>
            ...
            <div className="mt-6 flex justify-end gap-4">
                <button
                    className="flex items-center px-4 py-2 text-sm font-semibold text-blue-600 hover:text-blue-800 border border-blue-600 rounded-lg"
                    onClick={() => alert('Edit Exam')}
                >
                    <Edit className="mr-2 h-4 w-4" />
                    Edit Exam
                </button>
                <button
                    className="flex items-center px-4 py-2 text-sm font-semibold text-red-600 hover:text-red-800 border border-red-600 rounded-lg"
                    onClick={() => alert('Delete Exam')}
                >
            ...
            <div>
                <h2 className="text-xl font-semibold">Users and Their Exam Dates</h2>
